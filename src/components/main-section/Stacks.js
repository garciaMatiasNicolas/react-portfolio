  ...
  return (
    <div className="row mt-5 w-100 mb-5 bg-white">
      <div className='col-12 col-lg-6 d-flex flex-column justify-content-bewteen align-items-center'>
        ...
        <p className="App-paragraph fs-5 w-75 text-left mt-3">I've my prefferences, i like to code with a Js library such as React but this are all the stacks with which I can develop your own website</p>
      </div>
